...
![What we are building](graphics/image_07_001.jpg)
...
![Installing frontend components with Bower](graphics/image_07_002.jpg)
...
4.  Go to http://localhost:3000/, and you will see the following result:
    ...
    ![Adding some CSS](graphics/image_07_003.jpg)
...
3.  Now every time we change a file, we can see the following message on the terminal:
    ...
    ![Adding live reload plugin](graphics/image_07_004.jpg)
...
![Checking the application folder structure](graphics/image_07_005.jpg)
...
![Adding socket.io behavior on the client side](graphics/image_07_006.jpg)
...
2.  Go to http://localhost:3000/, insert the name **John Doe**, and you will see the following result:
    ...
    ![Starting the chat application](graphics/image_07_007.jpg)
...
3.  Go to http://localhost:3000/ and insert the name, **Max Smith**. You should see the following result on the right-hand panel:
    ...
    ![Starting the chat application](graphics/image_07_008.jpg)
...
4.  On the **John Doe** screen, type this message: **Any Body there?**
    ...
    ![Starting the chat application](graphics/image_07_009.jpg)

    马克斯·史密斯屏幕聊天截图

5.  Go back to the John Doe screen and check the message and answer it, as we did in the following image:

    ![Starting the chat application](graphics/image_07_010.jpg)
