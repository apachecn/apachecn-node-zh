# MongoDB、Mongoose 和 REST 应用编程接口——第 1 部分
...
![](images/d2d25ad4-75ae-45ac-ba0e-26abbda50968.png)

GitHub repo 应该是第一个链接，它是我们想要的——节点-MongoDB-原生存储库——如果我们向下滚动，我们可以看到几个重要的链接:

![](images/c02996e6-da4d-4ffa-8612-721523ea48e4.png)
...
![](images/08418c55-f4af-4d52-8f3c-239701eb5c9f.png)
...
![](images/9407d5a3-011f-4cbe-90eb-9c4a31b55d58.png)

如果我们进入有 MongoDB 服务器的选项卡，我们可以看到我们得到了一个新的连接:连接被接受。正如你在下面的截图中看到的，那个连接被关闭了，这太棒了:

![](images/6f1192b4-66da-47e3-bde5-7f094bbc762f.png)
...
![](images/bc451fb0-aae9-404f-9d73-cb56589083ef.png)
...
![](images/3618889d-f9e2-4b28-9548-d34f9e2f0315.png)
...
![](images/952d1c7e-fe2e-40e3-a249-8ac9ca3e4b68.png)
...
![](images/1efe9b45-0509-4625-9bcf-cf85ef2e1968.png)
...
![](images/029bbfea-6826-4ece-ac25-f10f834c5966.png)
...
![](images/dc75c923-aecb-4897-9cde-e6938420c025.png)
...
![](images/288d7028-2bd9-4e7e-8fc1-fab1a9e60a0c.png)
...
![](images/7d48f1c5-d083-463a-859e-3c4a91749924.png)
...
![](images/724333b0-a6d8-4e53-b09d-2266f7b30fdc.png)
...
![](images/f429516c-25b3-4fae-8689-052b7c4c1ceb.png)

我们得到一个看起来像物体的东西。如果我再次运行它，我们会得到一个新的；它们都是独一无二的:

![](images/b2b1feb5-0446-44b9-b276-e57ae9a9279e.png)
...
![](images/c2f51586-1c3b-4789-bdef-5628eaa6ce3a.png)
...
![](images/98401436-3619-4b3e-ade6-1924c766d1fe.png)
...
![](images/3c47a41b-466f-4f2a-8554-d765a66781ee.png)
...
![](images/b3502cf4-287e-423b-bd7e-91e512b9dc29.png)

在终端内部，我可以重新运行脚本来证明它已经改变。我要通过运行*控制* + *C* 关闭脚本，然后我可以重新运行它:

![](images/b94e60a9-afce-4a1a-b615-bc1a35291560.png)
...
![](images/2c632bdf-9012-4b71-acf5-fdccbb9420ad.png)
...
![](images/c40589de-95cc-48bc-bcfd-25d7c72ee229.png)
...
![](images/fd2e42a1-88bf-4fc0-a885-e024cf5e2cc4.png)
...
这不是一个模板字符串，但我将继续用一个替换它，用```替换引号。现在，我可以通过`count`。
...
![](images/9fd9155b-32b9-4c22-9771-82a526d89065.png)
...
![](images/389ebd7e-0161-4c1b-a31d-bab563cc5621.png)
...
![](images/4fd344a9-de63-45ff-a7b0-fd5353c06e3b.png)
...
![](images/8c2070ea-2d27-43e3-b609-f3a4948be5bc.png)
...
![](images/ce67bd02-10cd-4cf0-b6ba-6754e2b5a4aa.png)
...
![](images/1bd89ea4-3f8b-4cb0-9ff0-194e62d0d9e0.png)
...
![](images/8fc55286-909e-408d-8951-e315c454287f.png)
...
![](images/7744c074-3a75-4b6b-8dc0-2d5f890da471.png)
...
![](images/9a571ad9-8625-46c8-813d-118afc431db6.png)
...
![](images/30033a3b-581d-4d26-9540-f20270b17f0a.png)
...
![](images/d13d8b43-2602-4ce3-9343-ca45bc01c592.png)
...
![](images/c21e6884-fda6-41aa-aa79-316cdfcf9085.png)
...
![](images/93f0f8e8-ab68-4b27-a89e-83c04cd39268.png)
...
![](images/f0a3f3dc-cabf-4503-bc29-7152fe580144.png)
...
![](images/b3fb5a61-5cdd-45ea-85fc-52ebca362ae0.png)

我可以通过刷新 Robomongo 内部的收藏来验证这一点:

![](images/84ba63a2-1cd9-48ff-90df-833865eb2282.png)
...
![](images/6f97eb20-78fa-402b-a775-9cfc27409e28.png)
...
![](images/6ea4eeaf-5eb6-4035-be14-aa56c0efb3c1.png)

如果我们前往 Robomongo，我们可以确认该值确实已更新。我们可以在旧文档中看到这一点，这里的值是假的。我将为托多斯打开一个新的视角:

![](images/936011e3-b25f-4701-ac2d-f15393c3216f.png)
...
![](images/ea8c2677-365e-4533-80bb-e53952b498a4.png)
...
![](images/92d5c78a-7d25-4e19-aad4-155256400d0a.png)
...
![](images/4bce35a0-d75f-4431-8e26-93dbc12f7e02.png)

我们的更新文档就在这里。好吧，让我们通过提交我们的更改来结束这一部分。在终端中，我将运行`git status`以便我们可以查看对存储库的所有更改:

![](images/a0f74cdc-051d-4c3b-9a02-3539a35a2383.png)
