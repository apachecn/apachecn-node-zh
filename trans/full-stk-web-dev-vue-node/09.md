Testing an MEVN Application <link href="css/style.css" rel="stylesheet" type="text/css">  
...
如果您在创建此应用程序时选中了`e2e`选项，则还应该有`test/e2e/specs/test.js`文件。 如果没有，继续创建这个文件，并添加以下内容:
