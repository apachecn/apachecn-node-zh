Introducing REST APIs <link href="css/style.css" rel="stylesheet" type="text/css">  
...
现在代码已经就绪，让我们使用 Postman 应用程序测试这个端点。在 Postman 应用程序中，在 URL 中添加必要的详细信息。 当我们点击 Send 按钮时，我们应该看到如下的响应:
