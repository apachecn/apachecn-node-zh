...
在本章中，我们将从设置一个解析后端和一个Ionic项目开始。在此之后，我们将在它们之间创建一个连接，以达到我们期望的效果。
...
一旦我们准备好了课程，我们就可以开始创建我们的Ionic应用了。

# 设立Ionic项目

我们将通过运行以下命令来创建Ionic应用:
...
这将创建一个名为`whichapp`的空白Ionic启动器应用，它将为我们提供将解析服务连接到我们的项目所需的必要设置。
