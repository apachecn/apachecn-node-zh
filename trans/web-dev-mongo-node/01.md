...
如此高的性能和有希望的结果是Node 8(LTS)的发射日期从 2018 年 5 月推迟到 2018 年 10 月的原因。 目前我们正在使用非 lts 版本的Node 8。 为使用Node v4.x 的用户提供干净的替换。 X 及以上版本，没有损坏的库。 版本 8 也有各种内置的特性，如缓冲区改进和内置承诺方法等。 我们可以通过以下链接进行研究:[https://goo.gl/kMySCS](https://goo.gl/kMySCS)
