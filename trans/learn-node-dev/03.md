...
![](assets/af292fc6-2252-400f-b807-37dc2f91b054.png)
...
![](assets/df9afaf0-8b6c-4e8c-9725-21912fffd11a.png)
...
![](assets/374665b4-ede6-49f6-951c-ba21dba9f234.png)

到目前为止，yargs 还没有发光。这并不比上一个示例中的有用多少。当我们开始以键值对进行传递时，这才是真正的亮点，例如我们在[第 2 章](02.html)中*节点基础知识第 1 部分*的*获取输入*部分中使用的标题示例。我可以将我的`title`标志设置为`secrets`，按下*回车*，这一次，我们得到了更有用的东西：
...
![](assets/919e2194-261b-4da5-990e-302f7d5c7ae5.png)
...
![](assets/9fa340c3-87f8-47db-a5f7-208d1c145319.png)
...
![](assets/ada96524-27a8-475a-b80a-44a32452a2c9.png)
...
![](assets/33f36369-3d7e-43da-ab9e-aa99cb60f7c2.png)
...
![](assets/ed29fd53-b7d8-4c61-b33b-2b6c4fc782b3.png)
...
![](assets/1d14b0b9-86ba-4da5-9bd7-b5ac3513bce2.png)
...
![](assets/0ee76344-03dc-4a00-abe1-db51f870bdf1.png)
...
![](assets/794f3513-27f1-4303-b518-374f61bb6cbf.png)
...
![](assets/4d31df46-2653-4c07-b9bf-0f5f84665e7f.png)
...
![](assets/fba1baff-bbdb-4edf-95ba-fb767eb815cd.png)
...
![](assets/b1ede340-6c8d-49fd-8dde-a7365f3ca724.png)
...
![](assets/d09a35f5-c804-4889-9ba7-dbb6be822a14.png)
...
![](assets/cb8126dd-2d1b-4213-9419-38b86f7d9424.png)
...
![](assets/ad6c82b5-3af0-4fb8-8677-b579be0e6f68.png)
...
![](assets/c9217989-f386-40c8-93ca-2f52480535b7.png)
...
![](assets/20bb3654-0b57-403a-9e51-106a98033c0d.png)
...
![](assets/f5cb9595-6c07-44ad-8e25-2e20db88fab3.png)
...
![](assets/0b2d6170-3913-45eb-850b-b86ce5c4720e.png)
...
![](assets/c22407eb-04c5-4087-977d-bf2ad0afa79e.png)

当您现在访问 Atom 时，您可以看到`notes-data`文件确实存在，并且其中的数据看起来很棒：

![](assets/c6741579-1700-4aeb-a58d-9751e468208e.png)
...
![](assets/36e0f2c8-3e88-4e3d-a16c-d64b2162035b.png)

您在终端，所以我们将返回 JSON 文件。你可以在这里看到，我们还有一个注意事项：

![](assets/bca02d09-6b41-42b8-8744-c7a3c3e18ad9.png)
...
![](assets/2ae3b082-396c-487d-80cd-c823b4500d9e.png)

在我们的`notes-data`文件中，您可以看到两个注释显示：

![](assets/e1998cee-6016-4e62-aacf-8dec5cd336ff.png)
...
![](assets/d5e2807f-894f-416c-9d86-6117f68a76f2.png)

在我们的`notes-data.json`文件中，如果我向右滚动，我们有一个全新的注释，标题为`to buy`，正文为`food`：

![](assets/c5c5b8e9-aac7-4a78-af70-483f995a4e0d.png)
...
![](assets/bc0ca745-0319-4bf4-b419-5c68751c4556.png)
...
![](assets/5a370f6c-aeea-483e-bea1-63915466ed7b.png)
