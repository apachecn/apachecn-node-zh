...
![](assets/584340e3-28e2-4603-a985-6fa4ec7f1654.png)

我们将使用所有内容的默认值运行`npm init`，只需在每个步骤中点击*回车*：

![](assets/2276dd53-3b2e-41ad-ab4b-b70728616f3c.png)
...
![](assets/91f6a6aa-0422-4de1-b593-62b42deb4787.png)
...
![](assets/503f66d8-7558-4525-9aec-8c92b0a1bb99.png)
...
![](assets/8ef865ef-3a75-4f15-bce3-cc3dd95785f5.png)

如果在此页面上向下滚动，您将能够看到目录：

![](assets/fa505fff-2c7e-46bb-ad6e-43d622059cd7.png)
...
![](assets/d3d4bba5-1689-45b2-a839-d163e8cd6131.png)

但是如果你探索`package.json`，你会发现事情有点不同。在我们的`package.json`文件中，不是依赖项属性，而是`devDependencies`属性：

![](assets/732a982a-a748-4705-9bad-ce655510abc2.png)
...
![](assets/a48c09b3-f218-4fb9-925f-47c9b04e15bb.png)
...
![](assets/a3119576-d86c-4ad2-834f-c55d42ee1617.png)
...
![](assets/6e79b1dd-204b-4b42-8ef9-cd2f4eedebf7.png)
...
![](assets/fc218425-26d3-4080-b0c2-449f70e511e4.png)
...
![](assets/f9f81971-f62f-4d66-b24b-28de4fbf9eef.png)
...
![](assets/d97536cd-561d-4137-87b2-e23a7c65b50a.png)
...
![](assets/52e75c77-16e7-4be1-bc90-2ce1e09df52b.png)
...
![](assets/81443c9b-d50d-4ae9-a1ed-25ef54e1b1df.png)
...
![](assets/9abb5b25-aa06-48bc-b910-8b07bcfd103c.png)
...
![](assets/b511a1be-49e1-48ed-a0f9-3a2124c7d558.png)

然后我们可以移动到应用程序，查看`package.json`文件，如下面的屏幕截图所示，它看起来很棒：

![](assets/d77c03b2-9944-4f4e-a3cd-313fb6fcf88c.png)
...
![](assets/07986522-41a9-488c-a795-be6e3f87be25.png)
...
![](assets/e72bdf9c-5f95-4901-8a10-3a4233c84b58.png)
...
![](assets/06d5d04c-a118-49b5-9667-36c1cba16ae3.png)
...
![](assets/72f449b0-2275-49a4-b133-aeb0a0b2aa54.png)
...
![](assets/9c4f3131-3392-4529-b3f5-08f8ae8a8513.png)
...
![](assets/148b632f-b576-400e-86d7-7674d0c50863.png)
...
![](assets/7b487bf1-d06d-434b-a50b-8f9c765b1ac0.png)
...
![](assets/7b72f471-5ee4-4ee0-bf06-c9a76ac72b6c.png)
...
![](assets/870d8673-50d1-4c10-8a66-f07723443dc4.png)
...
![](assets/9cc4d4d4-50a6-40ce-9c22-8e3c5e3abf73.png)
...
![](assets/57f7879d-4325-48a3-8fb6-66d5fce52a11.png)
...
![](assets/d0b3cc75-0879-4062-9987-aef09129e358.png)
...
![](assets/51524f8b-6f39-41df-a287-bae020478cf9.png)
...
![](assets/be047123-f90a-43e9-9bfd-353d07cf9a68.png)
...
![](assets/7a4a5f75-7093-4d79-ae04-57d0e31a12fb.png)
...
![](assets/76187806-132d-4519-9569-5e31fe3216ed.png)
...
![](assets/40134642-c54b-48fa-b144-c17a57ca1977.png)
...
![](assets/da39513e-fd35-4ed0-a94a-7bc08925cbb0.png)
...
![](assets/7a5061b7-3cbd-41cd-9253-c2c8d0a81782.png)
...
![](assets/5ef4f4cd-2e72-43a1-aaa9-b21931ccd1d3.png)
...
![](assets/858b39b4-9141-4f4f-85d0-db38d9be3d0d.png)
...
![](assets/752973ad-70d3-4cf5-a5ea-d9694f49feeb.png)

它无法立即报告，因为它必须等待完成才能接到呼叫。请注意，我们的总测试时间现在大约为 1 秒。我们可以看到，我们有四项测试通过。摩卡咖啡还警告我们，当一项测试需要很长时间，因为它假设这不是预期的。节点内部的任何内容，即使是数据库或 HTTP 请求，都不应该花费将近一秒钟的时间，因此它本质上是在让我们知道，您的函数中可能存在错误，它需要非常非常长的时间来处理。然而，在我们的例子中，一秒钟的延迟显然是在`utils`内部设置的，因此没有必要担心这个警告。
...
![](assets/b050421f-a3c1-451c-bf59-a522f76a0edd.png)
...
![](assets/80634d18-e725-4f62-9bbc-0c7b819f8df0.png)

我们现在有了一种测试同步函数和异步函数的方法。这将使测试更加灵活。它可以让我们测试应用程序内部的所有内容。
