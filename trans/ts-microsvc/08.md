...
您可以安装 Chrome 扩展 node . js V8——督察经理(NiM),从 https://chrome.google.com/webstore/detail/nim-node-inspector-manage/gnhhdgbaldcilmgcpfddgdbkhjohddkj对于调试远程应用或者你甚至可以生成一个进程进行调试并指定一个端口:
