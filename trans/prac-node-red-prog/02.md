...
1.  Access the original Node.js website and download the installer.
    ...
    ![Figure 2.1 – Choosing a Recommended version installer ](image/Figure_2.1_B16353.jpg)
...
4.  Next, you need to accept the End-User License Agreement:
    ...
    ![Figure 2.2 – End-User License Agreement window ](image/Figure_2.2_B16353.jpg)

    图 2.2 -最终用户许可协议窗口

    您也可以更改的安装目标文件夹。 在本书中，将使用默认文件夹(**C:/Program Files/nodejs/**):

    ![Figure 2.3 – Installing the destination folder ](image/Figure_2.3_B16353.jpg)

    图 2.3 -安装目标文件夹

5.  No custom setup is needed on the next screen. You can select **Next** with only the default features selected:

    ![Figure 2.4 – No custom setup is needed ](image/Figure_2.4_B16353.jpg)
...
6.  On the following screen, you can click **Next** without checking anything. However, it's OK to install the tools that can be selected here. This includes the installations and settings the path of these environments (Visual C++, windows-build-tools, and Python):
    ...
    ![Figure 2.5 – Tools for Native Modules window ](image/Figure_2.5_B16353.jpg)
...
![Figure 2.6 – Choosing a recommended version installer ](image/Figure_2.6_B16353.jpg)
...
![Figure 2.7 – End-User License Agreement window ](image/Figure_2.7_B16353.jpg)

图 2.7 -最终用户许可协议窗口

您可以更改安装位置。 在本书中，默认位置(Macintosh HD)将被使用:

![Figure 2.8 – Install location ](image/Figure_2.8_B16353.jpg)
...
![Figure 2.9 – Node-RED flow editor ](image/Figure_2.9_B16353.jpg)
...
![Figure 2.10 – Node-RED flow editor ](image/Figure_2.10_B16353.jpg)
...
![Figure 2.11 – Accessing Node-RED via the Raspberry Pi menu ](image/Figure_2.11_B16353.jpg)

图 2.11 -通过树莓派菜单访问 Node-RED

从菜单启动 Node-RED 后，您应该检查终端上运行的 Node-RED 进程，并找到 Node-RED 流编辑器的 URL。 通常是与相同的 URL，可以直接通过 CLI 启动:

![Figure 2.12 – Checking the URL to access the Node-RED flow editor ](image/Figure_2.12_B16353.jpg)
...
![Figure 2.13 – Node-RED flow editor ](image/Figure_2.13_B16353.jpg)
