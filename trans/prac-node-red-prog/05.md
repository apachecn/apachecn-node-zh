...
1.  Let's start by executing Node-RED from the Raspberry Pi menu:
    ...
    ![Figure 5.1 – Running Node-RED from the Raspberry Pi menu ](image/Figure_5.01_B16353.jpg)
...
2.  You can check the status of Node-RED on your terminal. If **Started flows** is shown, Node-RED is ready to use:
    ...
    ![Figure 5.2 – Terminal of Raspberry Pi ](image/Figure_5.2_B16353.jpg)

    图 5.2 -树莓派的终端

3.  您可以使用**localhost:1880**URL访问 Node-RED 流编辑器:

![Figure 5.3 – Node-RED flow editor ](image/Figure_5.3_B16353.jpg)
...
2.  If everything goes well, you will see the following notice:
    ...
    ![Figure 5.4 – Successful grove.py installation ](image/Figure_5.4_B16353.jpg)
...
4.  After executing the command, you will see the following configuration window. Please select **Interfacing Options**:
    ...
    ![Figure 5.5 – Software configuration tool ](image/Figure_5.5_B16353.jpg)

    图 5.5 -软件配置工具

5.  Select **I2C**:

    ![Figure 5.6 – Enabling I2C ](image/Figure_5.6_B16353.jpg)
...
![Figure 5.7 – Grove Base HAT for Raspberry Pi ](image/Figure_5.07_B16353.jpg)
...
1.  Place the Grove Base HAT on your Raspberry Pi and screw it in:
    ...
    ![Figure 5.8 – Setting the Base HAT on your Raspberry Pi ](image/Figure_5.08_B16353.jpg)

    图 5.8 -在树莓派上设置 Base HAT

    这是什么 Grove - Light Sensor v1.2 - LS06-S 光电晶体管看起来像:

    ![Figure 5.9 – Grove - Light Sensor v1.2 ](image/Figure_5.09_B16353.jpg)
...
2.  Connect the Grove light sensor to the analog port of your Base HAT:
    ...
    ![Figure 5.10 – Connecting the light sensor to your Base HAT ](image/Figure_5.10_B16353.jpg)
    ...
    ![Figure 5.11 – Grove – Temperature&Humidity Sensor (SHT31) ](image/Figure_5.11_B16353.jpg)
...
![Figure 5.12 – Connecting the temperature/humidity sensor to your Base HAT ](image/Figure_5.12_B16353.jpg)
...
![Figure 5.13 – Use case 1 – getting light sensor data ](image/Figure_5.13_B16353.jpg)
...
![Figure 5.14 – Use case 2 – getting temperature/humidity data ](image/Figure_5.14_B16353.jpg)
...
1.  Click the menu at the top right and select **Manage palette** to open the settings panel:
    ...
    ![Figure 5.15 – Selecting Manage palette](image/Figure_5.15_B16353.jpg)
...
3.  After that, you can see the **node-red-contrib-grove-base-hat** node in the search window. Click the **Install** button:
    ...
    ![Figure 5.16 – Installing the node-red-contrib-grove-base-hat node ](image/Figure_5.16_B16353.jpg)

    图 5.16 -安装 node-red-contrib-grove-base-hat 节点

4.  在单击**Install**按钮后，您将看到一条消息，要求您阅读文档以找到有关此节点的更多信息。 如果有必要，请阅读文档，然后单击消息框上的**安装**按钮:

![Figure 5.17 – A message window to read the node documentation  ](image/Figure_5.17_B16353.jpg)

图 5.17 -读取节点文档的消息窗口

现在，您可以为 Grove Base HAT 使用节点了。 检查流编辑器中的面板。 在调色板的底部，你可以看到 Grove Base HAT 节点已经被添加:

![Figure 5.18 – Grove Base HAT nodes on your dashboard  ](image/Figure_5.18_B16353.jpg)
...
1.  Select the **grove light sensor v1_2** node from the palette on the left side of the flow editor and drag and drop it into the workspace to place it:
    ...
    ![Figure 5.19 – grove light sensor v1_2 ](image/Figure_5.19_B16353.jpg)
...
2.  After placing the **grove-light-sensor-v1_2** node, place the **inject** node and **debug** nodes and wire them so that the **grove-light-sensor-v1_2** node you placed is sandwiched between them:
    ...
    ![Figure 5.20 – Placing nodes and wiring them for the light sensor ](image/Figure_5.20_B16353.jpg)
...
5.  Earlier, we connected the Grove light sensor to the Grove Base HAT. If the connection is made according to the procedure in this tutorial, it should be connected to port A2, so select **A2** as the node setting value. If you are connecting to another port, select the port you are connecting to:
    ...
    ![Figure 5.21 – Select A2 as the port if you connected the sensor to A2 of Base HAT ](image/Figure_5.21_B16353.jpg)
...
![Figure 5.22 – Result of the light sensor flow ](image/Figure_5.22_B16353.jpg)
...
1.  Select the **grove temperature humidity sensor sht3x** node from the palette on the left side of the flow editor and drag and drop it into the workspace to place it:
    ...
    ![Figure 5.23 – grove temperature humidity sensor sht3x ](image/Figure_5.23_B16353.jpg)
...
2.  After placing the **grove-temperature-humidity-sensor-sht3x** node, place the **inject** and **debug** nodes, respectively, and wire them so that the **grove-temperature-humidity-sensor-sht3x** node you placed is sandwiched between them:
    ...
    ![Figure 5.24 – Placing the nodes and wiring them for the temperature and humidity sensor ](image/Figure_5.24_B16353.jpg)
...
3.  Next, check the settings of the **grove-temperature-humidity-sensor-sht3x** node and double-click the node to open the settings panel.
    ...
    ![Figure 5.25 – Already set to the I2C port ](image/Figure_5.25_B16353.jpg)
...
![Figure 5.26 – Result of the temperature/humidity sensor flow ](image/Figure_5.26_B16353.jpg)
