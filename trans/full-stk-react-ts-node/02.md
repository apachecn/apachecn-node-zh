...
![Figure 2.1 – The shape.ts output ](image/Figure_2.01_B15508.jpg)
...
1.  First, let's take a look at an example of the issue with using `any`. Go to VSCode and create a file called `any.ts`, and then type the following code:
    ...
    ![Figure 2.2 – any run result ](image/Figure_2.02_B15508.jpg)
...
![Figure 2.3 – any failing ](image/Figure_2.03_B15508.jpg)
...
![Figure 2.4 – unknown ](image/Figure_2.04_B15508.jpg)
...
![Figure 2.5 – Intersection result ](image/Figure_2.05_B15508.jpg)
...
![Figure 2.6 – A literal error ](image/Figure_2.06_B15508.jpg)
...
![Figure 2.7 – Function void results ](image/Figure_2.07_B15508.jpg)
...
![Figure 2.8 – Function type result ](image/Figure_2.08_B15508.jpg)
...
![Figure 2.9 – Classes error ](image/Figure_2.09_B15508.jpg)
...
![Figure 2.10 – getSet output ](image/Figure_2.10_B15508.jpg)

图 2.10–getSet 输出

为了进一步说明这一点，让我们尝试将[T0]行切换到[T1]。如果编译，您应该会看到以下错误：

![Figure 2.11 – Message field error ](image/Figure_2.11_B15508.jpg)
...
![Figure 2.12 – Employee interface results ](image/Figure_2.12_B15508.jpg)
...
![Figure 2.13 – The classInheritance result ](image/Figure_2.13_B15508.jpg)
...
![Figure 2.14 – The interfaceInheritance result ](image/Figure_2.14_B15508.jpg)
...
![Figure 2.15 – The classGeneric.ts result ](image/Figure_2.15_B15508.jpg)
